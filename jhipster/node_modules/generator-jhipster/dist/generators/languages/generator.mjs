            ...
            async loadNativeLanguage({ application, entities, control }) {
                ...
                if (application.enableTranslation) {
                    ...
                    control.getWebappTranslation = () => {
                        throw new Error(`Translations are not loaded, call ${chalk.yellow("'await control.loadClientTranslations'")} to load translations`);
                    };
        ...
        return {
            ...
            async writeClientTranslations({ application }) {
                if (!application.enableTranslation || application.skipClient)
                    return;
                await Promise.all(this.languagesToApply.map(lang => this.writeFiles({
            ...
            async translateFile({ application }) {
                if (!application.enableTranslation || application.skipServer)
                    return;
