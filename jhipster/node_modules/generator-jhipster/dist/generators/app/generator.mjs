...
import { GENERATOR_APP, GENERATOR_COMMON, GENERATOR_LANGUAGES, GENERATOR_CLIENT, GENERATOR_PAGE, GENERATOR_SERVER, GENERATOR_BOOTSTRAP_APPLICATION_BASE, } from '../generator-list.mjs';
...
export default class JHipsterAppGenerator extends BaseApplicationGenerator {
    ...
    get composing() {
        return this.asComposingTaskGroup({
            ...
            async composePages() {
                if (!this.jhipsterConfig.pages || this.jhipsterConfig.pages.length === 0)
                    return;
                await Promise.all(this.jhipsterConfig.pages.map(page => {
