...
import { MAIN_DIR, SERVER_MAIN_RES_DIR, SERVER_MAIN_SRC_DIR, SERVER_TEST_RES_DIR, SERVER_TEST_SRC_DIR, TEST_DIR, dockerContainers, javaDependencies, } from '../generator-constants.mjs';
import { loadRequiredConfigIntoEntity, prepareEntityPrimaryKeyForTemplates } from '../base-application/support/index.mjs';
import { loadRequiredConfigDerivedProperties, prepareEntity as prepareEntityServerForTemplates, getPomVersionProperties, getGradleLibsVersionsProperties, addEntitiesOtherRelationships, hibernateSnakeCase, loadServerConfig, loadDerivedServerConfig, } from '../server/support/index.mjs';
    ...
    get loading() {
        return this.asLoadingTaskGroup({
            async loadApplication({ application }) {
                ...
                application.gradleVersion = this.useVersionPlaceholders ? 'GRADLE_VERSION' : GRADLE_VERSION;
