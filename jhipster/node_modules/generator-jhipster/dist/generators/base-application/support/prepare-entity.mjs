...
export default function prepareEntity(entityWithConfig, generator, application) {
    ...
    entityWithConfig.entityFileName = _.kebabCase(entityWithConfig.entityNameCapitalized + _.upperFirst(entityWithConfig.entityAngularJSSuffix));
    ...
    entityWithConfig.entityTranslationKeyMenu = _.camelCase(entityWithConfig.clientRootFolder
