...
import { reservedKeywords, databaseTypes, applicationTypes, entityOptions, fieldTypes, validations, clientFrameworkTypes, } from '../../jdl/jhipster/index.mjs';
...
const { Validations: { PATTERN, MINBYTES, MAXBYTES, MINLENGTH, MAXLENGTH, MIN, MAX, REQUIRED, UNIQUE }, } = validations;
const prompts = {
    ...
    const prompts = [
        {
            ...
            choices: () => this.entityConfig.fields.map(field => {
    ...
    const prompts = [
        {
            ...
            choices: () => this.entityConfig.relationships.map(rel => {
                return {
...
function logFieldsAndRelationships() {
    ...
    if (this.entityConfig.fields.length > 0) {
        ...
        this.entityConfig.fields.forEach(field => {
            ...
            this.log.log(chalk.red(field.fieldName) +
