...
import { getDBTypeFromDBValue, hibernateSnakeCase, loadDerivedPlatformConfig, loadDerivedServerConfig, loadServerConfig, } from '../server/support/index.mjs';
...
export default class EntityGenerator extends BaseApplicationGenerator {
    constructor(args, options, features) {
        ...
        this.option('client-root-folder', {
            description: 'Use a root folder name for entities on client side. By default its empty for monoliths and name of the microservice for gateways',
            type: String,
        });
