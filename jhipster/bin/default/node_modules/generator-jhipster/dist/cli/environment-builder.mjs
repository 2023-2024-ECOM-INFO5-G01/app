...
export default class EnvironmentBuilder {
    ...
    async _lookupJHipster() {
        ...
        (await this.env.lookup({ packagePaths: [packagePath], lookups: [lookup] })).forEach(generator => {
            ...
            assert(generator.namespace.startsWith(`${CLI_NAME}:`), `Error on the registered namespace ${generator.namespace}, make sure your folder is called generator-jhipster.`);
        });
        return this;
    }
