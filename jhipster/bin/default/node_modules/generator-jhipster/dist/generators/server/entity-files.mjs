...
import { moveToJavaEntityPackageSrcDir, moveToJavaEntityPackageTestDir, moveToJavaPackageSrcDir, moveToJavaPackageTestDir, replaceEntityFilePathVariables, } from './support/index.mjs';
            ...
            templates: [
                {
                    ...
                    renameTo: generator => replaceEntityFilePathVariables(generator, `${generator.entityAbsoluteFolder}/service/_EntityClass_Service.java`),
                },
            ],
        },
    ],
