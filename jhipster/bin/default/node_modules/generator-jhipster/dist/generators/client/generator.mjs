    ...
    get loading() {
        return this.asLoadingTaskGroup({
            ...
            loadPackageJson({ application }) {
                ...
                this.loadNodeDependenciesFromPackageJson(application.nodeDependencies, this.fetchFromInstalledJHipster(GENERATOR_CLIENT, 'resources', 'package.json'));
            },
        });
    }
    ...
    get preparing() {
        return this.asPreparingTaskGroup({
            ...
            addExternalResource({ application, source }) {
                source.addExternalResourceToRoot = ({ resource, comment }) => this.editFile(`${application.clientSrcDir}index.html`, createNeedleCallback({
