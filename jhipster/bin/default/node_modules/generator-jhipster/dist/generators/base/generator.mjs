 ...
 */
export default class JHipsterBaseBlueprintGenerator extends CoreGenerator {
    fromBlueprint;
    sbsBlueprint;
    delegateToBlueprint;
    blueprintConfig;
     ...
     */
    async composeWithBlueprints(subGen, options) {
    ...
    async _composeBlueprint(blueprint, subGen, extraOptions = {}) {
        ...
        const blueprintGenerator = await this.composeWith(generatorNamespace, finalOptions);
