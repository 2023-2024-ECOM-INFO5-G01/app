 ...
 */
export declare function createImporterFromFiles(files: any, configuration?: any): {
    /**
 ...
 */
export declare function createImporterFromContent(jdlString: any, configuration?: any): {
    /**
     * Processes JDL files and converts them to JSON.
     * @param {Object} logger - the logger to use, default to the console.
     * @returns {object} the state of the process:
