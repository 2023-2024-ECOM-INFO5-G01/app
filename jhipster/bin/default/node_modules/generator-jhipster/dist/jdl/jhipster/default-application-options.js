...
export function getConfigForClientApplication(options = {}) {
...
export function getConfigForAuthenticationType(options = {}) {
...
export function getConfigForPackageName(options = {}) {
...
export function getConfigForCacheProvider(options = {}) {
    if (options[REACTIVE]) {
...
export function getConfigForTranslation(options = {}) {
...
export function getConfigForDatabaseType(options = {}) {
...
export function getServerConfigForMonolithApplication(customOptions = {}) {
    const options = {
...
export function getServerConfigForGatewayApplication(customOptions = {}) {
    const options = {
        ...commonDefaultOptions,
        [CLIENT_FRAMEWORK]: ANGULAR,
        [SERVER_PORT]: OptionValues[SERVER_PORT],
...
export function getServerConfigForMicroserviceApplication(customOptions = {}) {
