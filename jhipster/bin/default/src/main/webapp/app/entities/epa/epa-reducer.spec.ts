...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './epa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EPA_LIST actions', async () => {
    ...
    it('dispatches FETCH_EPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EPA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EPA actions', async () => {
      const expectedActions = [
        {
