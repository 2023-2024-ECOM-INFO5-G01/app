...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './albumine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALBUMINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALBUMINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALBUMINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALBUMINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALBUMINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALBUMINE actions', async () => {
      const expectedActions = [
        {
