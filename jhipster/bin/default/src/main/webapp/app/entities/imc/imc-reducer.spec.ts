...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './imc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMC_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMC actions', async () => {
      const expectedActions = [
        {
