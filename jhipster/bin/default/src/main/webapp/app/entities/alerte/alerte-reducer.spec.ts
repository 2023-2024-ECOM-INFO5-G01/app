...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './alerte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALERTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALERTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALERTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALERTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALERTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALERTE actions', async () => {
      const expectedActions = [
        {
