...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rappel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAPPEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_RAPPEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RAPPEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RAPPEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RAPPEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RAPPEL actions', async () => {
      const expectedActions = [
        {
