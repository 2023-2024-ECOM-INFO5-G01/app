...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './poids.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POIDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_POIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POIDS actions', async () => {
      const expectedActions = [
        {
