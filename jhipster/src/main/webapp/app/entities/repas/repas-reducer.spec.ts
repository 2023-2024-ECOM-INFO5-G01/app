...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './repas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPAS actions', async () => {
      const expectedActions = [
        {
