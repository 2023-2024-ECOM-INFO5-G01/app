...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ehpad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EHPAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_EHPAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EHPAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EHPAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EHPAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EHPAD actions', async () => {
      const expectedActions = [
        {
