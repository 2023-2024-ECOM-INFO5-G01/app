...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aliment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALIMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALIMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALIMENT actions', async () => {
      const expectedActions = [
        {
