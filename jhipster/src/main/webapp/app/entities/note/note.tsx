  ...
  return (
    <div>
      <h2 id="note-heading" data-cy="NoteHeading">
        <Translate contentKey="ecomApp.note.home.title">Notes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ecomApp.note.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/note/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ecomApp.note.home.createLabel">Create new Note</Translate>
          </Link>
        </div>
      </h2>
        ...
        {noteList && noteList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ecomApp.note.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="ecomApp.note.date">Date</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('date')} />
                </th>
                ...
                <th>
                  <Translate contentKey="ecomApp.note.patient">Patient</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/note/${note.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ecomApp.note.home.notFound">No Notes found</Translate>
            </div>
          )
        )}
      </div>
