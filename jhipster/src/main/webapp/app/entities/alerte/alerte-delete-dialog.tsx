...
export const AlerteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecomApp.alerte.delete.question">
        <Translate contentKey="ecomApp.alerte.delete.question" interpolate={{ id: alerteEntity.id }}>
          Are you sure you want to delete this Alerte?
        </Translate>
      </ModalBody>
      <ModalFooter>
